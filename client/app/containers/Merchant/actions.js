  ...
  return async (dispatch, getState) => {
    try {
      ...
      const response = await axios.get(
        `https://vm9qie5ock.execute-api.ap-southeast-1.amazonaws.com/prod/api/merchant`,
        {
          params: {
            page: v ?? 1,
            limit: 20,
...
export const searchMerchants = (filter) => {
  return async (dispatch, getState) => {
    try {
      ...
      const response = await axios.get(
        `https://vm9qie5ock.execute-api.ap-southeast-1.amazonaws.com/prod/api/merchant/search`,
        {
          params: {
            search: filter.value,
          },
...
export const disableMerchant = (merchant, value, search, page) => {
  return async (dispatch, getState) => {
    try {
      await axios.put(
        `https://vm9qie5ock.execute-api.ap-southeast-1.amazonaws.com/prod/api/merchant/${merchant._id}/active`,
        {
          merchant: {
            isActive: value,
          },
...
export const approveMerchant = (merchant, search, page) => {
  return async (dispatch, getState) => {
    try {
      await axios.put(
        `https://vm9qie5ock.execute-api.ap-southeast-1.amazonaws.com/prod/api/merchant/approve/${merchant._id}`
      );
...
export const rejectMerchant = (merchant, search, page) => {
  return async (dispatch, getState) => {
    try {
      await axios.put(
        `https://vm9qie5ock.execute-api.ap-southeast-1.amazonaws.com/prod/api/merchant/reject/${merchant._id}`
      );
...
export const merchantSignUp = (token) => {
  return async (dispatch, getState) => {
    try {
      ...
      await axios.post(
        `https://vm9qie5ock.execute-api.ap-southeast-1.amazonaws.com/prod/api/merchant/signup/${token}`,
        merchant
      );
  ...
  return async (dispatch, getState) => {
    try {
      const response = await axios.delete(
        `https://vm9qie5ock.execute-api.ap-southeast-1.amazonaws.com/prod/api/merchant/delete/${merchant._id}`
      );
