  ...
  return async (dispatch, getState) => {
    try {
      ...
      const response = await axios.get(
        `https://vm9qie5ock.execute-api.ap-southeast-1.amazonaws.com/prod/api/product/list`,
        {
          params: {
            ...payload,
          },
...
export const fetchStoreProduct = (slug) => {
  return async (dispatch, getState) => {
    ...
    try {
      const response = await axios.get(
        `https://vm9qie5ock.execute-api.ap-southeast-1.amazonaws.com/prod/api/product/item/${slug}`
      );
...
export const fetchBrandProducts = (slug) => {
  return async (dispatch, getState) => {
    try {
      ...
      const response = await axios.get(
        `https://vm9qie5ock.execute-api.ap-southeast-1.amazonaws.com/prod/api/product/list/brand/${slug}`
      );
...
export const fetchProductsSelect = () => {
  return async (dispatch, getState) => {
    try {
      const response = await axios.get(
        `https://vm9qie5ock.execute-api.ap-southeast-1.amazonaws.com/prod/api/product/list/select`
      );
...
export const fetchProducts = () => {
  return async (dispatch, getState) => {
    try {
      ...
      const response = await axios.get(
        `https://vm9qie5ock.execute-api.ap-southeast-1.amazonaws.com/prod/api/product`
      );
...
export const fetchProduct = (id) => {
  return async (dispatch, getState) => {
    try {
      const response = await axios.get(
        `https://vm9qie5ock.execute-api.ap-southeast-1.amazonaws.com/prod/api/product/${id}`
      );
  ...
  return async (dispatch, getState) => {
    try {
      ...
      const response = await axios.post(
        `https://vm9qie5ock.execute-api.ap-southeast-1.amazonaws.com/prod/api/product/add`,
        formData,
        {
  ...
  return async (dispatch, getState) => {
    try {
      ...
      const response = await axios.put(
        `https://vm9qie5ock.execute-api.ap-southeast-1.amazonaws.com/prod/api/product/${product._id}`,
        {
          product: newProduct,
        }
      );
...
export const activateProduct = (id, value) => {
  return async (dispatch, getState) => {
    try {
      const response = await axios.put(
        `https://vm9qie5ock.execute-api.ap-southeast-1.amazonaws.com/prod/api/product/${id}/active`,
        {
          product: {
            isActive: value,
          },
  ...
  return async (dispatch, getState) => {
    try {
      const response = await axios.delete(
        `https://vm9qie5ock.execute-api.ap-southeast-1.amazonaws.com/prod/api/product/delete/${id}`
      );
